...
<div id="page" class="site boxed-layout">
    ...
    <div class="container">
        <div class=" mx-auto my-4 px-3 row">
            <div class="col">
                <div class="col-md-11 rounded mx-auto" style="background-color: lavender">
                    <label class="mx-auto">Sản phẩm đã mua</label>
                    <table class="table">
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="pro" items="${lstsold}">
                                <tr>
                                    ...
                                    <td><img width="80px" src="<c:url value="/image/${pro.product.img1}"/>"></td>
                                    <td>${pro.product.price}</td>
                                    <td><a style="color:red;" href="<c:url value="/infor/?id=${pro.product.id}"/>">xem</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
            ...
            <div class="col">
                <div class="col-md-11 rounded mx-auto" style="background-color: lavender;">
                    <label class="mx-auto">Sản phẩm đã thích</label>
                    <table class="table">
                        <tr style="background-color: #00aced">
                            <th>
                                Tên sản phẩm
                    ...
                    <div style="height: 400px;overflow-x:hidden;">
                        <table class="table">
                            <tbody>
                            <c:forEach var="pro" items="${lstlike}">
                                <tr>
                                    <td>${pro.product.name}</td>
                                    <td><img width="80px" src="<c:url value="/image/${pro.product.img1}"/>"></td>
                                    <td>${pro.product.price}</td>
