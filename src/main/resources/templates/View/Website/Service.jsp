...
<div id="page" class="site boxed-layout">
  ...
  <section class="portfolio section-space">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3 col-md-4 offset-md-2 col-12">
          <div class="section-title default text-center">
            <div class="section-top">
              <h1><span>Sản phẩm</span><b>Our Service</b></h1>
            </div>
        ...
        <div class="col-12">
          <div class="portfolio-menu">
            ...
            <ul id="portfolio-nav" class="portfolio-nav tr-list list-inline cbp-l-filters-work">
              ...
              <li data-filter=".animation" class="cbp-filter-item">Đồng hồ thời trang</li>
              <li data-filter=".branding" class="cbp-filter-item">Đồng hồ cao cấp</li>
              <li data-filter=".business" class="cbp-filter-item">Đồng hồ thể thao</li>
            </ul>
            <!--/ End Portfolio Nav -->
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="portfolio-main">
            <div id="portfolio-item" class="portfolio-item-active">
                ...
                <!-- Single Portfolio -->
                  <c:forEach var="item" items="${fashionlst}">
                      <div class="cbp-item animation">
                        <div class="single-portfolio">
                          <div class="portfolio-head overlay">
                            <img src="<c:url value="/image/${item.img1}"/>" alt="#">
                            <a class="more" href="<c:url value="/infor/?id=${item.id}"/>"><i class="fa fa-long-arrow-right"></i></a>
                          </div>
                          <div class="portfolio-content">
                            <h4><a href="<c:url value="/infor/?id=${item.id}"/>">${item.name}</a></h4>
                            <p style="color: red">${item.price-item.discount} vnd</p>
                          </div>
                        </div>
                      </div>
                  </c:forEach>
                <!--/ End Single Portfolio -->
              <c:forEach var="item" items="${diamondlst}">
              ...
              <c:forEach var="item" items="${sportlst}">
    ...
    <div class="row mx-auto w-25">
      <a class="col" href="<c:url value="/service?page=${page-1}"/>">
        <button>Prev</button>
      </a>
      <span class="col" style="color: red">${page}</span>
      <a class="col" href="<c:url value="/service?page=${page+1}"/>">
        <button>Next</button>
      </a>
    </div>
